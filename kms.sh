...
#	Open Source: https://github.com/bestgu/kms
#	Official document: https://bestgu.cn
#====================================================
...
mkdir /usr/local/kms
cd /usr/local/kms
git clone https://ghproxy.com/https://github.com/Wind4/vlmcsd.git
cd vlmcsd
make
cd bin
...
case "$1" in
	...
	*)
	...
	echo "更多教程请访问：https://github.com/bestgu/kms"
	;;
esac

# 转载请保留版权：https://bestgu.cn
